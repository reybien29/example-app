...
<div class="page-anim">
    <div class="form-page-header">
        ...
        <div>
            <h1>Edit Contact</h1>
            <p>Updating details for <strong>{{ $contact->name }}</strong>.</p>
        </div>
    </div>
    ...
    <div class="form-card">
        <form action="{{ route('contact.update', $contact->id) }}" method="POST">
                    ...
                    >
                        ...
                        @foreach ($categories as $cat)
                            <option
                                ...
                                {{ old('category_id', $contact->category_id) == $cat->id ? 'selected' : '' }}
                            >
            ...
            <div class="form-actions">
                ...
                <form action="{{ route('contact.destroy', $contact->id) }}" method="POST" style="margin-left: auto;">
                    @csrf
                    @method('DELETE')
                    <button
                        type="submit"
...
(function () {
    ...
    filterCategories(); // run on page load to respect old() / existing values
})();
</script>
@endsection
